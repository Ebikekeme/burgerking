      ...
      <div className="modallist">
        <div className="modallist-1  ">
          ...
          <div className="span">
            ...
            <p className="knife2 takeout ">Order is served in restaurant</p>
          </div>
        </div>
        ...
        <div className="modallist-1">
          ...
          <div className="span">
            <h4>Takeout</h4>
            <p className="Takeout2  takeout">Order is packed for outside</p>
          </div>
        </div>
        ...
        <div className="modallist-1">
          ...
          <div className="span">
            <h4>Delivery</h4>
            <p className="delivery2  takeout">Order is delivered to you</p>
          </div>
        </div>
      </div>
    </div>
